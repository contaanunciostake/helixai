...
import { Power, Activity, MessageSquare, Users, TrendingUp, Settings, RefreshCw, Download, AlertCircle, CheckCircle, XCircle, Building2, Home, MapPin } from 'lucide-react';
...
export function AIraImob() {
  ...
  const [logs, setLogs] = useState([
    ...
    { id: 3, timestamp: '2025-10-16 14:35:45', type: 'info', message: 'Nova conversa iniciada com +55 11 91234-5678' },
    { id: 4, timestamp: '2025-10-16 14:38:12', type: 'success', message: 'Lead qualificado: Maria Santos - Interesse em apartamento 2 quartos' },
    { id: 5, timestamp: '2025-10-16 14:40:30', type: 'info', message: 'Visita agendada para 18/10/2025 às 14h' },
    { id: 6, timestamp: '2025-10-16 14:42:15', type: 'success', message: 'Enviado catálogo de imóveis disponíveis' },
  ]);

  const [stats] = useState({
    conversasAtivas: 18,
    leadsQualificados: 62,
    visitasAgendadas: 31,
    taxaConversao: 28.5
  });
    ...
    <DashboardLayout>
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white">AIra Imobiliária</h1>
            <p className="text-gray-400 mt-1">Gerenciamento e monitoramento do robô imobiliário</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Card className="bg-[#1a2332] border-[#2d3748]">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              <CardTitle className="text-sm font-medium text-gray-400">Visitas Agendadas</CardTitle>
              <MapPin className="h-4 w-4 text-purple-500" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-white">{stats.visitasAgendadas}</div>
              <p className="text-xs text-gray-500 mt-1">Últimos 7 dias</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#1a2332] border-[#2d3748]">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex justify-between items-center p-3 bg-[#0f1419] rounded-lg">
                ...
                <span className="text-sm text-white font-medium">08:00 - 22:00</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-[#0f1419] rounded-lg">
              ...
              <div className="flex justify-between items-center p-3 bg-[#0f1419] rounded-lg">
                ...
                <span className="text-sm text-white font-medium">1.8 segundos</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-[#0f1419] rounded-lg">
                <span className="text-sm text-gray-400">Imóveis no Catálogo</span>
                <span className="text-sm text-white font-medium">247 ativos</span>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-[#1a2332] border-[#2d3748]">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex justify-between items-center p-3 bg-[#0f1419] rounded-lg">
                ...
                <span className="text-sm text-white font-medium">22 dias, 14 horas</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-[#0f1419] rounded-lg">
              ...
              <div className="flex justify-between items-center p-3 bg-[#0f1419] rounded-lg">
                ...
                <span className="text-sm text-white font-medium">WhatsApp, Telegram</span>
              </div>
            </CardContent>
          </Card>
        </div>
